    ...
    <section class="property section">
    	<div class="container">
            <div class="title-fullwidth">
                <h1 class="no-margin title white-text">Resultados de la Búsqueda</h1>
            </div>
            <div class="row">
    			<p class="center no-margin title-secundary">6</p>
    			<h4 class="center no-margin">Ipsum Dolor</h4>
    		</div>
            <div class="row">
                @for ($i=0; $i < 6; $i++)
                            ...
                            <div class="card-stacked">
                                <div class="card-content">
                                    ...
                                    <div class="desc no-margin">
        			                    ...
        			                    <div class="desc__box-icon no-padding">
        			                        <h4>Lorem</h4>
        			                        <div>
